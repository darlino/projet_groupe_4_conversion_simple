// Global Variables
// variable pour ajouter une devise
const addCurrencyBtn = document.querySelector(".add-currency-btn");
// variable pour ajouter la liste des devises
const addCurrencyList = document.querySelector(".add-currency-list");
// variablle pour afficher la liste des devises par defaut 
const currenciesList = document.querySelector(".currencies");
// API utilise
const dataURL = "https://api.exchangeratesapi.io/latest";
// devises qui s'afficheront au demarrage
//
const initiallyDisplayedCurrencies = ["USD", "EUR", "GBP", "JPY", "RUB"];
let baseCurrency; // devises de base
let baseCurrencyAmount; // Montant devise de base

// devise 
// j'ai fait un copie colle sur un site pour triver xa
let currencies = [
  {
    name: "US Dollar",
    abbreviation: "USD",
...
// Les fonctions
// fonction pour afficher la liste des devises
...
// fonction pour ajouter de la liste des devises dans la liste des devises principales
...
// fonction pour afficher la liste des devises principale par defaut
...
// fonction pour mettre une nouvelle base a chaque fois qu'on choisi une devise
...
// fonction pour changer dynamiquement les valeurs des montants par devises
...
// fonction pour se figer sur une devise
...
// fonction pour afficher la liste des devises caches avec un rendu html 
...
// foncttion pour afficher la liste des devises principale avec un rendu html
...
// fonction pour instacier la fonction precedente
...
// pour utiliser l'API et recuperer toute les donnees
fetch(dataURL)
  .then(res => res.json())
  .then(data => {
